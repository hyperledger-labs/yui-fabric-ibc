...
import (
	...
	fabapp "github.com/hyperledger-labs/yui-fabric-ibc/simapp"
...
func (coord *Coordinator) SetChannelClosed(
	...
	case Fabric:
		source.GetApp().(*fabapp.IBCApp).IBCKeeper.ChannelKeeper.SetChannel(source.GetContext(), testChannel.PortID, testChannel.ID, channel)
	}
