...
type SequenceManager interface {
	...
	GetSequenceFromHeight(ctx sdk.Context, height exported.Height) (*Sequence, error)
...
func (m sequenceManager) GetSequenceFromHeight(ctx sdk.Context, height exported.Height) (*Sequence, error) {
	return m.GetSequence(authtypes.StubFromContext(ctx), height.GetRevisionHeight())
}
